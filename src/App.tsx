  ...
  useEffect(() => {
    ...
    if (path === "/" || path === "/home") {
      ...
      const landingPagePaths = [
        "/", "/home", "/artists", "/trending", "/playlists", "/discover", "/charts", "/podcasts", "/community",
    ...
    <div className="bg-[#121212] min-h-screen text-white flex flex-col md:flex-row font-sans">
      ...
      <main className="flex-1 p-6 md:p-10 pb-36 overflow-y-auto max-h-screen">
        {isAdmin && currentTab !== "admin" && (
          <div className="bg-gradient-to-r from-teal-500/10 via-emerald-500/5 to-transparent border border-teal-500/25 rounded-2xl p-4 mb-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-lg shadow-teal-950/20">
            <div className="flex items-center gap-3">
              <span className="text-xl">🚀</span>
              <div>
                <h4 className="text-xs font-black text-teal-400 uppercase tracking-wider font-sans">
            ...
            <button
              onClick={() => {
                window.history.pushState({}, "", "/admin?tab=google-integrations");
                setCurrentPathname("/admin");
                setCurrentTab("admin");
              }}
              className="bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-400 hover:to-emerald-500 text-black text-[10px] font-mono font-black uppercase px-4 py-2.5 rounded-xl transition-all shadow-md shadow-teal-500/10 hover:scale-[1.02] cursor-pointer"
            >
