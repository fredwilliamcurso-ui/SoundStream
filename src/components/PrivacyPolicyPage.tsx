...
export default function PrivacyPolicyPage({ onNavigate }: PrivacyPolicyPageProps) {
  const sections = [
    ...
    { id: "soundstream-login", title: "Soundstream Login", icon: <Flame className="w-5 h-5 text-pink-500 animate-pulse" /> },
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-8 py-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-10">
            ...
            <section id="info-collected" className="bg-zinc-900/40 border border-white/5 rounded-2xl p-6 sm:p-8 backdrop-blur-sm space-y-4">
              ...
              <div className="space-y-3 text-sm leading-relaxed text-zinc-350">
                ...
                <ul className="list-disc pl-5 space-y-2 text-zinc-400">
                  ...
                  <li>
                    <strong className="text-zinc-300">Third-Party Integration Data:</strong> Metrics shared when linking Google Sign-In, YouTube Sync, or Soundstream authentication as detailed below.
                  </li>
                </ul>
              </div>
            </section>
            ...
            {/* 4. Soundstream Login */}
            <section id="soundstream-login" className="bg-zinc-900/40 border border-white/5 rounded-2xl p-6 sm:p-8 backdrop-blur-sm space-y-4">
              <h2 className="text-xl font-extrabold text-white flex items-center gap-2.5 border-b border-white/5 pb-3">
                <Flame className="w-5 h-5 text-pink-500 animate-pulse" />
                <span>4. Soundstream Login & Integration</span>
              </h2>
              <div className="space-y-3 text-sm leading-relaxed text-zinc-350">
                <p>
                  SoundStream includes integrations for Soundstream creators to link their profiles and sync social activities. When you authorize Soundstream Login:
                </p>
                <ul className="list-disc pl-5 space-y-2 text-zinc-400">
                  <li>
                    We receive a secure open identifier (Open ID), your public Soundstream username (e.g., <code>@username</code>), and an authorization access token.
                  </li>
                  <li>
                    We use this data solely to bind your Soundstream profile to your SoundStream catalog and, if you are a verified creator, display your latest public short video clips on your creator page.
                  </li>
                  <li>
                    All Soundstream OAuth codes are exchanged server-side via TLS 1.3. Your personal credentials are never exposed to clients. You can instantly unlink your Soundstream profile via your settings panel.
                  </li>
                </ul>
              </div>
            </section>
