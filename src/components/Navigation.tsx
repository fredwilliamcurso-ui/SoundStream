...
export default function Navigation({
  ...
  const listenerMenuItems = [
    { id: "home", label: "MUSIC", icon: Home, action: () => handleNavigation("home") },
    { id: "video", label: "VIDEO", icon: Video, action: () => handleNavigation("video") },
    { id: "live", label: "LIVESTREAM", icon: Radio, action: () => handleNavigation("live") },
    { id: "library", label: "LIBRARY", icon: Disc, action: () => handleNavigation("library") },
    { id: "music-news", label: "MUSIC NEWS", icon: BookOpen, action: () => handleNavigation("music-news") },
    { id: "radio", label: "RADIO", icon: Radio, action: () => handleNavigation("radio") },
  ...
  const artistMenuItems = [
    ...
    { id: "live-center", label: "Live Center", icon: Sparkles, action: () => handleNavigation("live-center") },
    { id: "radio", label: "SoundStreamy Radio", icon: Radio, action: () => handleNavigation("radio") },
    { id: "games", label: "Games Center", icon: Gamepad2, action: () => handleNavigation("games") },
    { id: "agency", label: "Agency & Record Label", icon: Building, action: () => handleNavigation("agency") },
    { id: "ads", label: "Ads Manager", icon: Megaphone, action: () => handleNavigation("ads") },
