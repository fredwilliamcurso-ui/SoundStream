...
async function main() {
  ...
  const targets = [
    ...
    { path: "src/assets/images/soundstream_logo_1782150206757.jpg", width: 512, format: "jpeg" as const },
    { path: "public/logo.png", width: 512, format: "png" as const },
    { path: "public/icon.png", width: 512, format: "png" as const },
    { path: "public/android-chrome-192x192.png", width: 192, format: "png" as const },
    { path: "public/android-chrome-512x512.png", width: 512, format: "png" as const },
    { path: "public/apple-touch-icon.png", width: 180, format: "png" as const },
    
    // Android launcher icon (mipmap)
    { path: "android/app/src/main/res/mipmap-mdpi/ic_launcher.png", width: 48, format: "png" as const },
    { path: "android/app/src/main/res/mipmap-hdpi/ic_launcher.png", width: 72, format: "png" as const },
    { path: "android/app/src/main/res/mipmap-xhdpi/ic_launcher.png", width: 96, format: "png" as const },
    { path: "android/app/src/main/res/mipmap-xxhdpi/ic_launcher.png", width: 144, format: "png" as const },
    { path: "android/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png", width: 192, format: "png" as const },
    
    // Rounded Android Launcher icons
    { path: "android/app/src/main/res/mipmap-mdpi/ic_launcher_round.png", width: 48, format: "png" as const, rounded: true },
    { path: "android/app/src/main/res/mipmap-hdpi/ic_launcher_round.png", width: 72, format: "png" as const, rounded: true },
    { path: "android/app/src/main/res/mipmap-xhdpi/ic_launcher_round.png", width: 96, format: "png" as const, rounded: true },
    { path: "android/app/src/main/res/mipmap-xxhdpi/ic_launcher_round.png", width: 144, format: "png" as const, rounded: true },
    { path: "android/app/src/main/res/mipmap-xxxhdpi/ic_launcher_round.png", width: 192, format: "png" as const, rounded: true }
  ];
  ...
  for (const target of targets) {
    ...
    let pipeline = sharp(svgBuffer).resize(target.width, target.width);
